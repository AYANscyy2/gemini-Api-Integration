      ...
      <div className="min-h-screen flex justify-center bg-black">
        ...
        <div className="flex flex-col justify-center items-center absolute inset-0 px-4 sm:px-8 md:px-16 lg:px-24 ">
          <div className="w-full py-10">
            <div className="h-[calc(85vh-80px)] bg-transparent bg-opacity-30 backdrop-blur-md w-full rounded-3xl px-4 text-center">
              <div className="flex flex-col w-full h-full justify-center items-center">
                <h1 className=" text-4xl sm:text-5xl md:text-6xl text-transparent bg-clip-text bg-gradient-to-r from-neutral-600 to-neutral-400 font-light">What can I help with?</h1>
            ...
            <div className="h-[80px] mt-3 w-full bg-black rounded-3xl text-white p-[1px] text-xl shadow-lg bg-gradient-to-tl from-blue-500 via-purple-500 to-pink-500">
              <div className='w-full h-full flex justify-end items-center p-4 gap-2 bg-black rounded-3xl'>
                <div className='bg-neutral-600 p-2 rounded-2xl'>
            <LogIn className='cursor-pointer text-black' />
                </div>
                <div className='bg-neutral-600 p-2 rounded-2xl'>
            <AudioLines className='cursor-pointer text-black' />
                </div>
              </div>
            </div>
          </div>
